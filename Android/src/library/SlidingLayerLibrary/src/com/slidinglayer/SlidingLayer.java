...
public class SlidingLayer extends FrameLayout {
    ...
    public SlidingLayer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int shadowRes = ta.getResourceId(R.styleable.SlidingLayer_shadowDrawableSlidingLayer, -1);
        if (shadowRes != -1) {
            setShadowDrawable(shadowRes);
        }

        // Sets the shadow width
        setShadowWidth((int) ta.getDimension(R.styleable.SlidingLayer_shadowWidthSlidingLayer, 0));
